...
import { getDebugLog, getErrorLog, getInfoLog, getSuccessLog, getWarnLog, levels, type LogEntry } from "./helper.js";
import { LEVEL, MESSAGE, SPLAT } from "triple-beam";

const prettyPrintWithColor = () =>
  winston.format.printf((message) => {
    const stripped = Object.assign({}, message) as LogEntry & Record<string | symbol, unknown>;
